...
cfg_all <- read_csv("task/cfg_all.csv")
imputed_shapes_count <- read_csv("task/before_imputation/imputed_shapes_count.csv")
...
write_csv(cfg_all, "task/cfg_all_clean.csv")
